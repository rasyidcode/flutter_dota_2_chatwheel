...
class _FakeChatwheelLine extends _i1.Fake implements _i4.ChatwheelLine {}

class _FakeChatwheelPack extends _i1.Fake implements _i5.ChatwheelPack {}

class _FakeChatwheelEventResult extends _i1.Fake
    implements _i6.ChatwheelEventResult {}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockChatwheelScraper extends _i1.Mock implements _i12.ChatwheelScraper {
  MockChatwheelScraper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.ChatwheelLine getLine(_i13.Element? audio) =>
      (super.noSuchMethod(Invocation.method(#getLine, [audio]),
          returnValue: _FakeChatwheelLine()) as _i4.ChatwheelLine);
  @override
  _i5.ChatwheelPack getPack(_i13.Element? tr) =>
      (super.noSuchMethod(Invocation.method(#getPack, [tr]),
          returnValue: _FakeChatwheelPack()) as _i5.ChatwheelPack);
  @override
  _i6.ChatwheelEventResult getEvents(String? responseBody) =>
      (super.noSuchMethod(Invocation.method(#getEvents, [responseBody]),
              returnValue: _FakeChatwheelEventResult())
          as _i6.ChatwheelEventResult);
}
